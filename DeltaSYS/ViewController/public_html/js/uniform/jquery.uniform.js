...
(function($) {
  ...
  $.fn.uniform = function(options) {
    ...
    function doSelect(elem){
      ...
      /** new code:18/08/2010 (para que utilice el width usado en la etiqueta select) ***/
      //set the width              
        divTag.css("width",$(elem).css("width"));
        var width=(parseInt($(elem).css("width").replace("px",""))-32)+"px";
        selected.css("width",width);        
        spanTag.css("width",width);
